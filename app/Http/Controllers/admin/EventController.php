...
public function destroy($id)
{
    ...
    // Delete the invitation image file if it exists
    if ($event->event_invitation && file_exists(public_path($event->event_invitation))) {
        unlink(public_path($event->event_invitation));
    }
