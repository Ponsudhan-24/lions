...
@section('content')
    ...
    <div class="p-3 mb-4 text-white text-center" style="background: linear-gradient(115deg, #0f0b8c, #77dcf5); border-radius: 8px;">
        <h2 class="mb-0" style="color: white;">Member Profile</h2>
    </div>
...
<!-- Nav Tabs -->
<ul class="nav nav-tabs flex-wrap justify-content-center border-0 px-2" id="profileTabs" role="tablist">
    ...
    <div class="tab-pane fade " id="parent" role="tabpanel">
        <div class="container p-4" style="background-color:rgb(195, 206, 218); border-radius: 8px;">
