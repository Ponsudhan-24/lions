...
<style>
    @media (max-width: 576px) {
        ...
        #memberTabs::-webkit-scrollbar {
            display: none; /* Hide scrollbar for a clean look */
        }

        .nav-item {
            flex: 0 0 auto; /* Keep items in one row */
...
<div class="row mt-2">
    <div class="col-12">
        <ul class="nav nav-pills justify-content-start flex-row d-flex" id="memberTabs">
            <li class="nav-item">
